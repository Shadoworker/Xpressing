...
<head>
    ...
    <meta content="Deploying your own Java/Grails3 app on Scalingo is as easy as pie: JUST CLICK THIS BUTTON! It will be up in less than 2 minutes!" property='og:description'>
    <meta charset="utf-8">
    ...
    <title>Greetings from a sample Grails 3 app!</title>
    <style>
...
<body>
  <div class="container hero">
    <div class="love">
      ...
      <img class="tech-logo" alt="Ruby" src="https://cdn.scalingo.com/documentation/technologies/grails-logo.svg">
    </div>
    <h1>Greetings from a sample Grails 3 app <br/> deployed with Gradle!</h1>
    <h2>
      <span style="display:block;"><span class="one-liner">Deploying your own Gradle/Grails3 app on Scalingo</span> is easy as pie:</span>
      <a class="btn" href="https://my.scalingo.com/deploy?source=https://github.com/Scalingo/sample-java-grails3">Just click this button!</a>
      <span style="display:block;">It will be up in less than 2 minutes!</span>
    </h2>
    <p>The code of this sample lives <a href="https://github.com/Scalingo/sample-java-grails3">on GitHub</a>. You can find <a href="http://samples.scalingo.com">more samples here</a>.</p>
  </div>
  <footer>
    <div class="container">
      <p>
